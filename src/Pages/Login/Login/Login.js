        ...
        <div className=' flex justify-center'>
            <div className='w-96 p-5 border rounded'>
                ...
                <div className='flex justify-between items-center mt-3'>
                    <p className='hover:text-purple-900 underline'><Link to='/register'>Create an Account</Link></p>
                    <p className='hover:text-purple-900 underline'><Link>Forget Password</Link></p>
                </div>
